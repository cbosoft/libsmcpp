...
private:
	...
	void to_fpe2(uint8_t *data, uint32_t &size) const;
	void to_sp78(uint8_t *data, uint32_t &size) const;
	void to_flt_(uint8_t *data, uint32_t &size) const;
...
public:
	...
	void get_data(uint32_t type, uint8_t *data, uint32_t &size) const;
